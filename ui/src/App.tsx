      ...
      <header className="bg-white border-b border-slate-200/80 sticky top-0 z-30 px-6 sm:px-8 py-3.5 shadow-xs">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            {/* Brand Logo */}
            <div className="w-9 h-9 rounded-xl shadow-xs select-none overflow-hidden ring-1 ring-slate-200/80 shrink-0 bg-slate-900">
              <img src="/app-icon.png" alt="TimesFM Icon" className="w-full h-full object-cover" />
            </div>
